...
import { Calculator, BarChart3, Truck, Users, Clock } from 'lucide-react';
  ...
  const applications = [
    {
      ...
      description: 'AI-driven JIT manufacturing for cost-efficient, seamless car production. 🚗⚙️',
            ...
            <div className="rounded-2xl border border-border p-8 bg-muted/30">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
                  <div>
                    <h3 className="font-medium">AI-Powered JIT Supply Chain</h3>
                    <p className="text-sm text-muted-foreground">New case study on optimizing supplier and logistics allocation in JIT manufacturing.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
